...
{
    public class CommCashLc : ProSearchModel<CommCashLc>
    {
        ...
        public string WayOfEntry { get; set; }
        ...
        public string QuantitySetMultiple { get; set; }

        public string BillOfImportCode { get; set; }
        public string DateOfBLMultiple { get; set; }
        public string DateOfBillMultiple { get; set; }
