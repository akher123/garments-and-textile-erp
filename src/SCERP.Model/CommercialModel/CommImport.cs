...
{
    public class CommImport : ProSearchModel<CommImport>
    {
        public CommImport()
        {
            CommImportDetails = new HashSet<CommImportDetails> ();
        }
        ...
        public ICollection<CommImportDetails> CommImportDetails { get; set; }
    }
}
