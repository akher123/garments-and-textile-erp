...
{
    public interface IPayrollReportManager
    {
        ...
        List<WeekendOTSheetView> GetWeekendOTSheetInfo(int? companyId, int? branchId, int? branchUnitId,
            ...
            int? departmentLineId, int? employeeTypeId, string employeeCardId,
            int year, int month,
            DateTime? fromDate, DateTime? toDate, int employeeCategoryId);

        List<EmployeeAllPaymentSheetView> GetEmployeeAllPaymentSheetInfo(int? companyId, int? branchId, int? branchUnitId,
            int? branchUnitDepartmentId,
            int? departmentSectionId, int? departmentLineId, int? employeeTypeId, string employeeCardId,
            int year, int month, DateTime? fromDate, DateTime? toDate, int employeeCategoryId);

        List<EmployeeAllPaymentSheetView> GetEmployeeAllPaymentSheetInfoGrossDeduction(int? companyId, int? branchId, int? branchUnitId, int? branchUnitDepartmentId,
            int? departmentSectionId, int? departmentLineId, int? employeeTypeId, string employeeCardId,
            int year, int month, DateTime? fromDate, DateTime? toDate, int employeeCategoryId);
        ...
        List<ExtraOTWeekendOTAndHolidayOTSheetView> GetExtraOTWeekendOTAndHolidayOTSheetInfo(int? companyId,
            int? branchId, int? branchUnitId, int? branchUnitDepartmentId,
            int? departmentSectionId, int? departmentLineId, int? employeeTypeId, string employeeCardId,
            int year, int month, DateTime? fromDate, DateTime? toDate, int employeeCategoryId);
        ...
        List<SalarySummaryView> GetEmployeeSalarySummaryAll(int? companyId, int? branchId,
            List<int> branchUnitIdList,
