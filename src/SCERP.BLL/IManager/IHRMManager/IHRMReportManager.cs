...
{
    public interface IHRMReportManager
    {
        ...
        List<AttendanceSummaryByDesignationModel> GetAttendanceSummaryByDesignationInfo(int companyId, int branchId,
            int branchUnitId, int? branchUnitDepartmentId, int? departmentSectionId, int? departmentLineId,
            int? employeeTypeId, int? branchUnitWorkShiftId, DateTime? transactionDate);
        ...
        List<AttendanceModel> GetEmployeeAttendanceModelInfo(int? companyId, int? branchId, int? branchUnitId,
            int? branchUnitDepartmentId, int? departmentSectionId, int? departmentLineId, int? employeeTypeId, string employeeCardId,
            int? branchUnitWorkShiftId, DateTime? fromDate, DateTime? toDate, string attendanceStatus,
        ...
        List<EmployeeLeaveDetailModel> GetEmployeeLeaveDetailInfo(int? companyId, int? branchId,
            int? branchUnitId,
            int? branchUnitDepartmentId, int? departmentSectionId,
            int? departmentLineId, int? employeeTypeId, int? employeeGradeId, int? employeeDesignationId,
            int? genderId, DateTime? joiningDateBegin, DateTime? joiningDateEnd,
        ...
        string GetAgeAndFitnessCertificateInfo(Guid employeeId, string userName, DateTime prepareDate);

        string GetJobApplicationInfo(Guid employeeId, string userName, DateTime prepareDate);

        string GetJobVerificationInfo(Guid employeeId, Guid? userId, DateTime prepareDate);

        string GetLeaveApplicationWorkerInfo(Guid employeeId, string employeeCardId, string userName, DateTime prepareDate);
        ...
        string GetLeaveApplicationStaffInfo(Guid employeeId, string employeeCardId, string userName, DateTime prepareDate);

        string GetNominationFormInfo(Guid employeeId, string userName, DateTime prepareDate);
