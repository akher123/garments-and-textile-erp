...
{
    public interface IBranchUnitDepartmentManager
    {
        ...
        int EditranchUnitDepartment(BranchUnitDepartment model);
        int SaveBranchUnitDepartment(BranchUnitDepartment model);
        bool IsExistBranchUnitDepartment(BranchUnitDepartment model);
        int BranchUnitDepartment(int branchUnitId);
        ...
        IEnumerable GetBranchUnitDepartmentsByBranchUnitId(int branchUnitId);

        IEnumerable GetAllPermittedBranchUnitDepartmentsByBranchUnitId(int branchUnitId);
    }
}
