...
{
    public class HeadOfDepartmentRepository : Repository<HeadOfDepartment>, IHeadOfDepartmentRepository
    {
        public HeadOfDepartmentRepository(SCERPDBContext context)
            : base(context)
        {

        }
        //public List<HeadOfDepartment> GetAllHeadOfDepartments(int startPage, int pageSize, out int totalRecords, SearchFieldModel searchFieldModel,
        //    HeadOfDepartment model)
        //{
        //    IQueryable<HeadOfDepartment> headOfDepartments;
        //    try
        //    {
        //        headOfDepartments =
        //            Context.HeadOfDepartments.Include(x => x.BranchUnitDepartment)
        ...
        //                .Include(x => x.Employee.EmployeeCompanyInfo)
        //                .Where(
        //                    x =>
        //                        x.IsActive &&
