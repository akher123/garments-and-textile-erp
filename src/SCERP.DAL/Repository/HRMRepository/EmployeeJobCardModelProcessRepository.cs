...
{
    public class EmployeeJobCardModelProcessRepository : Repository<EmployeeJobCardModel>, IEmployeeJobCardModelProcessRepository
    {
        public EmployeeJobCardModelProcessRepository(SCERPDBContext context)
            : base(context)
        {
        ...
        public List<EmployeeJobCardModel> GetEmployeeJobCardModelProcessedInfo(int startPage, int pageSize, EmployeeJobCardModel model, SearchFieldModel searchFieldModel)
        {
            ...
            try
            {
                ...
                var employeeJobCardModelRecords = Context.Database.SqlQuery<EmployeeJobCardModel>("SPGetEmployeeJobCardModelProcessedInfo @StartRowIndex, @MaxRows, @CompanyId, " +
                ...
                return employeeJobCardModelRecords;
        ...
        public List<EmployeesForJobCardModelProcessModel> GetEmployeesForJobCardModelProcess(SearchFieldModel searchFieldModel, EmployeeJobCardModel model)
        {
            try
            {
                ...
                var employeesForJobCardModelProcess = Context.Database.SqlQuery<EmployeesForJobCardModelProcessModel>("SPGetEmployeesForJobCardProcess  @CompanyId, " +
                                                                         "@BranchId, @BranchUnitId, @BranchUnitDepartmentId, " +
                ...
                return employeesForJobCardModelProcess;
        ...
        public int ProcessBulkEmployeeJobCardModel(SearchFieldModel searchFieldModel, EmployeeJobCardModel model)
        {
            ...
            try
            {
                ...
                using (conn)
                {
                    SqlCommand cmd = new SqlCommand("dbo.SPProcessBulkEmployeeJobCardModel", conn);
