...
{
    public interface IEmployeeJobCardProcessRepository : IRepository<EmployeeJobCard>
    {
        ...
        List<EmployeesForJobCardProcessModel> GetEmployeesForJobCardProcess(SearchFieldModel searchFieldModel,
            EmployeeJobCard model);
