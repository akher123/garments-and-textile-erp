...
--- SELECT [dbo].[fnGetLastDayOTHoursModel]('AE1E9C92-418E-424B-BE18-509A58C00F3D','2015-10-11')

CREATE FUNCTION [dbo].[fnGetLastDayOTHoursModel] 
(  
...
AS BEGIN
			...
			DECLARE @LastDayOTHours NUMERIC = NULL,
