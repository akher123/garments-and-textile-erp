...
---Select [dbo].[fnGetWorkingDaysModel] ('FC136FFD-5E86-43F1-B7CB-3B5D53037DC0','2015-10-01','2015-10-31')

CREATE FUNCTION [dbo].[fnGetWorkingDaysModel] (  
...
AS BEGIN
	...
	SET @TotalWorkingDays = (DATEDIFF(DAY, @FromDate, @ToDate) + 1) - (dbo.fnGetHolidaysModel(@EmployeeId,@FromDate,@ToDate)) - (dbo.fnGetWeekendModel(@EmployeeId,@FromDate,@ToDate))
