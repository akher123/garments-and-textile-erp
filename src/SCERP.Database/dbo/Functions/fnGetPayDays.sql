...
---Select [dbo].[fnGetPayDays] ('FC136FFD-5E86-43F1-B7CB-3B5D53037DC0','2015-10-01','2015-10-31')

CREATE FUNCTION [dbo].[fnGetPayDays] (  
...
AS BEGIN
	...
	SET @TotalPayDays = (DATEDIFF(DAY, @FromDate, @ToDate) + 1) -  
	                    (dbo.fnGetAbsentDays(@EmployeeId,@FromDate,@ToDate)) -
						(dbo.fnGetEmployeeTotalPenaltyAttendanceDays(@EmployeeId, @JoiningDate, @QuitDate, @FromDate, @ToDate))- 
						(dbo.fnGetIndividualLeaveDays(@EmployeeId,@FromDate,@ToDate,6))
