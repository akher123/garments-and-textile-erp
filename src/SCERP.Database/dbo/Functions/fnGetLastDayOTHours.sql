...
--- SELECT [dbo].[fnGetLastDayOTHours]('AE1E9C92-418E-424B-BE18-509A58C00F3D','2015-10-11')

CREATE FUNCTION [dbo].[fnGetLastDayOTHours] 
(  
...
AS BEGIN
		 ...
		 DECLARE @LastDayOTHours NUMERIC(18,2) = NULL,
