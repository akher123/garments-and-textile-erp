CREATE VIEW dbo.VEmployeeIDCardInfoInBengali
AS
SELECT        Employee.EmployeeId, Employee.EmployeeCardId AS CardId, Employee.EmployeeCardId AS EmployeeCardId, Employee.NameInBengali AS Name, Company.NameInBengali AS CompanyName, 
                         Branch.NameInBengali AS Branch, Unit.NameInBengali AS Unit, Department.NameInBengali AS Department, Section.NameInBengali AS Section, Line.NameInBengali AS Line, 
                         EmployeeDesignation.TitleInBengali AS Designation, EmployeeGrade.NameInBengali AS Grade, skillSet.TitleInBengali AS EmployeeJobType, CONVERT(VARCHAR(20), Employee.JoiningDate, 103) JoiningDate, 
                         BranchUnitDepartment.BranchUnitDepartmentId AS BranchUnitDepartmentId, DepartmentSection.DepartmentSectionId AS DepartmentSectionId, DepartmentLine.DepartmentLineId AS DepartmentLineId, 
                         Employee.PhotographPath, Branch.Id AS BranchId, Company.Id AS CompanyId, employeeType.Id AS EmployeeTypeId, BloodGroup.GroupName AS BloodGroup, employee.FathersNameInBengali, 
                         EmployeePermanentAddress.MailingAddressInBengali, EmployeePermanentAddress.PostOfficeInBengali, PoliceStation.NameInBengali AS PoliceStationInBengali, District.NameInBengali AS DistrictNameInBengali, 
                         EmployeePresentAddress.ContactPersonPhone AS EmergencyPhoneInBengali, employee.NationalIdNo, employee.BirthRegistrationNo
...
Begin DesignProperties = 
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'VEmployeeIDCardInfoInBengali';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'VEmployeeIDCardInfoInBengali';
