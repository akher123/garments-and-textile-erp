CREATE TABLE [dbo].[EarnLeaveConsumed] (
    [EarnLeaveConsumedId] INT              IDENTITY (1, 1) NOT NULL,
    ...
    [IsActive]            BIT              NULL,
    CONSTRAINT [PK_EarnLeaveConsumed] PRIMARY KEY CLUSTERED ([EarnLeaveConsumedId] ASC)
);
