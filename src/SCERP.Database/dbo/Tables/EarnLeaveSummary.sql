CREATE TABLE [dbo].[EarnLeaveSummary] (
    [EarnLeaveSummaryId]  INT              IDENTITY (1, 1) NOT NULL,
    ...
    [IsActive]            BIT              NULL,
    CONSTRAINT [PK_EarnLeaveSummary] PRIMARY KEY CLUSTERED ([EarnLeaveSummaryId] ASC)
);
