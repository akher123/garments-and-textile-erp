CREATE TABLE [dbo].[EmployeeInOut] (
...
GO
CREATE CLUSTERED INDEX [ClusteredIndex-20161102-170627]
    ON [dbo].[EmployeeInOut]([CompanyId] ASC, [TransactionDate] ASC, [EmployeeId] ASC);
