...
-- Description:	<> EXEC [SPProcessEmployeeSalary] 1, 1, 1, -1, -1, -1, -1,'7965', 2019, 09, '2019-08-26', '2019-09-25', 'superadmin'   (FULL MONTH PROCESS)
-- ====================================================================================================================================

CREATE PROCEDURE [dbo].[SPProcessEmployeeSalary]
	   @CompanyId INT = -1,
	   @BranchId INT = -1,
	   @BranchUnitId INT = -1,
...
SELECT  ejc.EmployeeId
	   ...
	   ,CASE WHEN ((ISNULL(ejc.TotalExtraOTHours, 0.0)) >= (ISNULL(ejc.TotalPenaltyOTHours, 0.0))) 
		...
		AND ejc.BranchUnitId IN (1,2,3) --- 1 for Garments, 2 for Knitting
		...
		UPDATE EmployeeProcessedSalary
