...
-- Description:	<> EXEC SPGetEmployeeJobCard_10PM  -1, -1, -1, -1, -1, -1, -1,'4637', 2017, 5, '2017-04-26', '2017-05-25', 'superadmin'			  
-- =================================================================================================================================

CREATE PROCEDURE [dbo].[SPGetEmployeeJobCard_10PM]	
				@CompanyId INT = -1,
				@BranchId INT = -1,
				@BranchUnitId INT = -1,
...
BEGIN
	   ...
	   (SELECT TOP (1) FromDate
		...
		FROM EmployeeJobCard_10PM ejc
		RIGHT JOIN EmployeeInOut_10PM eio
