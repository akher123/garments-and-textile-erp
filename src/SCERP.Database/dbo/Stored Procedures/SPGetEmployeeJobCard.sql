...
-- Description:	<> EXEC SPGetEmployeeJobCard  1, 1, -1, -1, -1, -1, -1,'', 2017, 7, '2017-06-26', '2017-07-25', 'superadmin'			  
-- =================================================================================================================================

CREATE PROCEDURE [dbo].[SPGetEmployeeJobCard]	
				@CompanyId INT = -1,
				@BranchId INT = -1,
				@BranchUnitId INT = -1,
