...
-- Description:	<> EXEC GetBalanceSheetNote  1, 38, '2019-07-01', '2019-10-31','20301'
-- ================================================================================

CREATE PROCEDURE [dbo].[GetBalanceSheetNote]
...
BEGIN
			...
			SET NOCOUNT ON;
									...
									INSERT INTO [dbo].[Acc_ReportControlTrialBalance]
										  ...
										  AND Acc_ControlAccounts2.ControlCode = @ControlCode
										  ...
										  -- Different Opening Balance for Income/Expense --
										  UPDATE Acc_ReportControlTrialBalance
										...
										SELECT @CompanyName      AS CompanyName
											  ...
											  ,CONVERT(VARCHAR, DATEADD(DAY, -1, @FromDate), 103)  AS FromDate
									  ...
									  GROUP BY [GroupCode]
											  ...
											  ,[ControlCode]
										      ,[ControlName]
									  ORDER  BY [GroupName],[SubGroupName],[SubControlName],[ControlName]	  	 					  					  														  						  											  							
END