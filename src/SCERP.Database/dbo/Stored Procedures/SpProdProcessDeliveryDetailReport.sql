...
CREATE procedure [dbo].[SpProdProcessDeliveryDetailReport]
@CompId varchar(3),
...
where BOST.OrderStyleRefId=@OrderStyleRefId and PD.CompId=@CompId and PD.ProcessRefId=@ProcessRefId
order by CB.JobNo