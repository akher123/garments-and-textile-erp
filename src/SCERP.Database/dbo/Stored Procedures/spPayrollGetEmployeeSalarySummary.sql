...
---- EXEC [spPayrollGetEmployeeSalarySummary] 1, 1, 2016, 4, '2016-03-26', '2016-04-25'

CREATE PROCEDURE [dbo].[spPayrollGetEmployeeSalarySummary] 
	@CompanyId INT,
	@BranchId INT,
...
BEGIN
    ...
    SELECT  
			...
			AND BranchUnitId  IN (SELECT BranchUnitId FROM @BranchUnitIdList)
