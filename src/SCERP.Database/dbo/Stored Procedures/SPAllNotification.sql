...
-- Description:	<> exec [SPAllNotification] 
-- =============================================
CREATE PROCEDURE [dbo].[SPAllNotification]
...
BEGIN
	...
	WHERE (TNA.SpecSheetId = @styleId OR  TNA.SpecSheetId = @orderId OR TNA.SpecSheetId = @jobId)
	AND E.[Status] = 1
