...
-- EXEC HRMSPGetEmployeeIndividualHoliday 0, 10, -1, -1, -1, -1, -1, -1, -1, -1, '2537', NULL, NULL, '2016-10-18', 'superadmin' 
-- =========================================================================================================================================


CREATE PROCEDURE [dbo].[HRMSPGetEmployeeIndividualHoliday]
...
BEGIN
	...
	BEGIN TRAN
		...
		SELECT DISTINCT
		ROW_NUMBER() OVER (ORDER BY employee.EmployeeCardId ASC) AS RowNumber,	
		0,
	   ...
	   ,EmployeeHoliday.FromDate 
	   ,EmployeeHoliday.ToDate
		...
		LEFT JOIN EmployeeHoliday ON EmployeeHoliday.EmployeeId = employeeCompanyInfo.EmployeeId
		...
		ORDER BY EmployeeCardId, FromDate DESC
