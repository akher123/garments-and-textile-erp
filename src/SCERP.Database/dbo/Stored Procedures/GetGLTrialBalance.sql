...
-- Description:	<> EXEC GetGLTrialBalance  1, 38, '2019-07-01', '2019-10-31'
-- ==============================================================================

CREATE PROCEDURE [dbo].[GetGLTrialBalance]
			...
			SET NOCOUNT ON;
									...
									INSERT INTO [dbo].[Acc_ReportControlTrialBalance]
									     ...
									     GROUP BY  [GroupCode]
												  ...
												  ,[GLCode]
												  ,[GLName]
										 ORDER  BY [GroupName],[SubGroupName],[SubControlName],[ControlName],[GLName]
