CREATE procedure [dbo].[SpOmCollarCuffBulkFabricOrderReport]
@CompId varchar(3),
@FabricOrderId int
as 
...
where FO.FabricOrderId=@FabricOrderId and FO.CompId=@CompId and CCD.PPQty>0 and Comp.CompType<>1
order by Comp.CompType, SZ.SizeRow
