...
-- Description: EXEC [SPFinalSettlement_10PM] '627DE633-DA86-4451-8237-FB91FBBEDFFA', 'superadmin','2019-02-25', 0 
-- ===============================================================================================================

CREATE PROCEDURE [dbo].[SPFinalSettlement_10PM]
...
BEGIN
		...
		SET NOCOUNT ON;
			...
			SELECT		  Company.NameInBengali AS CompanyName
						 ...
						 ,CONVERT(DECIMAL(18,2),EmployeeJobCard_10PM.GrossSalary/30) AS DailyGrossSalary
						 ,0.0 AS ServiceBenefit
						 ,EmployeeJobCard_10PM.WorkingDays AS TotalWorkingDays
						 ,(EmployeeJobCard_10PM.TotalOTHours + EmployeeJobCard_10PM.TotalExtraOTHours + EmployeeJobCard_10PM.TotalHolidayOTHours + EmployeeJobCard_10PM.TotalWeekendOTHours) AS TotalOTHours
						 ,EmployeeJobCard_10PM.PayDays AS TotalPayDays
						 ,EmployeeJobCard_10PM.EmployeeOTRate AS OverTimeRate
						 ,EmployeeJobCard_10PM.GrossSalary
						 ,CONVERT(DECIMAL(18,2),EmployeeJobCard_10PM.BasicSalary/30) AS DailyBasicSalary
						 ,EmployeeJobCard_10PM.BasicSalary

						 ,CAST((EmployeeJobCard_10PM.AbsentDays) AS INT) AS AbsentDays

						 ,CAST((EmployeeJobCard_10PM.GrossSalary/EmployeeJobCard_10PM.TotalDays * (EmployeeJobCard_10PM.Paydays + EmployeeJobCard_10PM.AbsentDays)) +((EmployeeJobCard_10PM.TotalOTHours + EmployeeJobCard_10PM.TotalExtraOTHours + EmployeeJobCard_10PM.TotalHolidayOTHours + EmployeeJobCard_10PM.TotalWeekendOTHours) * EmployeeJobCard_10PM.EmployeeOTRate) AS DECIMAL(18,2)) AS BenefitGiven
						 ,CAST([dbo].[fnGetEarnLeaveDays](Employee.EmployeeId,'2017-01-01', Employee.QuitDate) * CONVERT(DECIMAL(18,2),EmployeeJobCard_10PM.GrossSalary/30) AS DECIMAL(18,2)) AS EarnLeaveAmount
						 ,0.0 AS ServiceBenefitAmount
						 ,(CAST((EmployeeJobCard_10PM.GrossSalary/EmployeeJobCard_10PM.TotalDays * (EmployeeJobCard_10PM.Paydays + EmployeeJobCard_10PM.AbsentDays)) +((EmployeeJobCard_10PM.TotalOTHours + EmployeeJobCard_10PM.TotalExtraOTHours + EmployeeJobCard_10PM.TotalHolidayOTHours + EmployeeJobCard_10PM.TotalWeekendOTHours) * EmployeeJobCard_10PM.EmployeeOTRate) AS DECIMAL(18,2)) + CAST([dbo].[fnGetEarnLeaveDays](Employee.EmployeeId,'2017-01-01', Employee.QuitDate) * CONVERT(DECIMAL(18,2),EmployeeJobCard_10PM.GrossSalary/30) AS DECIMAL(18,2)) + EmployeeJobCard_10PM.AttendanceBonus) AS TotalAmountPaid
						 ,EmployeeJobCard_10PM.AttendanceBonus
						 ,EmployeeJobCard_10PM.AbsentFee
						 ...
						 ,CAST((CAST((EmployeeJobCard_10PM.GrossSalary/EmployeeJobCard_10PM.TotalDays * (EmployeeJobCard_10PM.Paydays + EmployeeJobCard_10PM.AbsentDays)) +((EmployeeJobCard_10PM.TotalOTHours + EmployeeJobCard_10PM.TotalExtraOTHours + EmployeeJobCard_10PM.TotalHolidayOTHours + EmployeeJobCard_10PM.TotalWeekendOTHours) * EmployeeJobCard_10PM.EmployeeOTRate) AS DECIMAL(18,2)) + CAST([dbo].[fnGetEarnLeaveDays](Employee.EmployeeId,'2017-01-01', Employee.QuitDate) * CONVERT(DECIMAL(18,2),EmployeeJobCard_10PM.GrossSalary/30) AS DECIMAL(18,2)) + EmployeeJobCard_10PM.AttendanceBonus - EmployeeProcessedSalary.TotalDeduction - @OtherDeduction) AS INT) AS NetAmount
						 ,dbo.fnIntegerToBengaliWords(CAST((CAST((EmployeeJobCard_10PM.GrossSalary/EmployeeJobCard_10PM.TotalDays * (EmployeeJobCard_10PM.Paydays + EmployeeJobCard_10PM.AbsentDays)) +((EmployeeJobCard_10PM.TotalOTHours + EmployeeJobCard_10PM.TotalExtraOTHours + EmployeeJobCard_10PM.TotalHolidayOTHours + EmployeeJobCard_10PM.TotalWeekendOTHours) * EmployeeJobCard_10PM.EmployeeOTRate) AS DECIMAL(18,2)) + CAST([dbo].[fnGetEarnLeaveDays](Employee.EmployeeId,'2017-01-01', Employee.QuitDate) * CONVERT(DECIMAL(18,2),EmployeeJobCard_10PM.GrossSalary/30) AS DECIMAL(18,2)) + EmployeeJobCard_10PM.AttendanceBonus - EmployeeProcessedSalary.TotalDeduction - @OtherDeduction) AS INT)) AS NetAmountInWord
...
FROM			    	Employee AS  employee
						...
						LEFT JOIN EmployeeJobCard_10PM ON EmployeeJobCard_10PM.EmployeeId = employee.EmployeeId AND @prepareDate BETWEEN EmployeeJobCard_10PM.FromDate AND EmployeeJobCard_10PM.ToDate
