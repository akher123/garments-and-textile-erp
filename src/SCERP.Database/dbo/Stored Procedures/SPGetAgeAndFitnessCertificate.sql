...
-- Description:	<> EXEC SPGetAgeAndFitnessCertificate '9BC5D1C6-0AD1-4D9E-A7F3-03CA3B155BC8', 'superadmin','2018-04-10' 
-- ====================================================================================================================

CREATE PROCEDURE [dbo].[SPGetAgeAndFitnessCertificate]
