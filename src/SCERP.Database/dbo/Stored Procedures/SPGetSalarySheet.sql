...
-- Description:	<> EXEC [SPGetSalarySheet] -1, -1, -1, -1, -1, -1, -1, '', 2017, 12, '2017-11-26', '2017-12-25', -1, 'superadmin'
-- ========================================================================================================================


CREATE PROCEDURE [dbo].[SPGetSalarySheet]
...
FROM					[dbo].[EmployeeProcessedSalary] eps
						...
						AND (eps.EmployeeId NOT IN (SELECT EmployeeId FROM EmployeeBankInfo WHERE IsActive = 1) OR eps.QuitDate BETWEEN @FromDate AND @ToDate)					    
						
						--AND eps.EmployeeCardId > 3784	
