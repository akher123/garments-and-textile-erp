...
-- Description:	<> EXEC [SPGetExtraOTSheetModel] 1, 1, 2, NULL, NULL, NULL, NULL, NULL,'2015-09-01','2015-09-30'
-- ===========================================================================================================

CREATE PROCEDURE [dbo].[SPGetExtraOTSheetModel]
...
BEGIN
	...
	SET NOCOUNT ON;
			...
			SELECT
				...
				FROM [dbo].[EmployeeProcessedSalaryModel] eps
