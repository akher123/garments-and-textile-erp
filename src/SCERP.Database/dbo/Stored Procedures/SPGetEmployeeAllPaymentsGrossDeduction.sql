...
-- Description:	<> EXEC SPGetEmployeeAllPaymentsGrossDeduction -1, -1, -1, -1, -1, -1, -1, '',2015,10, '2015-10-01','2015-10-31',1,'superadmin'
-- ===============================================================================================================================

CREATE PROCEDURE [dbo].[SPGetEmployeeAllPaymentsGrossDeduction]
