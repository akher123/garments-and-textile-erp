...
-- Description:	<> EXEC [SPProcessEmployeeInOutModel] 1, 1, NULL, NULL, NULL, NULL, '2018-03-26','2018-04-25',0,0, NULL, '5448','superadmin'
-- ================================================================================================================================================

CREATE PROCEDURE [dbo].[SPProcessEmployeeInOutModel]
	   @CompanyId INT = NULL,
	   @BranchId INT = NULL,
