...
-- Description:	<> EXEC [SPSalaryIncrementReportNew] 1, 1, 1, 6, 7, -1, '2016-12-26','2017-01-25', -1, '1718','superadmin', 5, 0
-- ==========================================================================================================================================

CREATE PROCEDURE [dbo].[SPSalaryIncrementReportNew]
...
BEGIN
						...
						(  
							...
							,(employeeSalary.BasicSalary  + employeeSalary.BasicSalary * @IncrementPercent * .01) + (employeeSalary.HouseRent + employeeSalary.HouseRent * @IncrementPercent * .01) + 1100  As NewGross
							...
							,(employeeSalary.BasicSalary  + employeeSalary.BasicSalary * @IncrementPercent * .01) + (employeeSalary.HouseRent + employeeSalary.HouseRent * @IncrementPercent * .01) + 1100 - employeeSalary.GrossSalary  AS TotalIncrement
