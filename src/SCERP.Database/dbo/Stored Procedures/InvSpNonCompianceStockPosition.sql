...
create PROCEDURE [dbo].[InvSpNonCompianceStockPosition]
...
FROM         Inventory_Item
WHERE     (LEFT(ItemCode, 5) = @SubGroupCode and Inventory_Item.ItemType=2)
...
select R.*, I.ItemName,MU.UnitName,SG.SubGroupName,G.GroupName From Inventory_RStock as R, Inventory_Item as I 
...
where R.ItemCode=I.ItemCode and I.ItemType=2 and (R.OQty>0  or R.RQty>0 or R.IQty>0)
END
