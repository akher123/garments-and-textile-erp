...
-- Description:	<> EXEC [SPProcessBulkEmployeeInOut] -1, -1, -1, -1, -1, -1, '2015-10-01','2015-10-31', -1, '0985','superadmin'
-- ============================================================================================================================

CREATE PROCEDURE [dbo].[SPProcessBulkEmployeeInOut]
	   @FromDate DateTime,
	   @ToDate DateTime,
...
BEGIN
		...
		AND CAST(employee.JoiningDate AS DATE) <= CAST(@EndDate AS DATE))	
