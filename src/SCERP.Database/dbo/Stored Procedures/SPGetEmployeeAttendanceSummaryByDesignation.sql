...
-- Description : EXEC [SPGetEmployeeAttendanceSummaryByDesignation]  -1, -1, -1, -1, -1, -1, -1, 46, '2018-05-17', 'superadmin'
-- ================================================================================================================================

CREATE PROCEDURE [dbo].[SPGetEmployeeAttendanceSummaryByDesignation]
