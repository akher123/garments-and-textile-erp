...
-- Description:	<> EXEC SPGetEmployeeJobCard_10PM_NoWeekend  -1, -1, -1, -1, -1, -1, -1,'4637', 2017, 5, '2017-04-26', '2017-05-25', 'superadmin'			  
-- =================================================================================================================================

CREATE PROCEDURE [dbo].[SPGetEmployeeJobCard_10PM_NoWeekend]	
				@CompanyId INT = -1,
				@BranchId INT = -1,
				@BranchUnitId INT = -1,
...
BEGIN
	   ...
	   (SELECT TOP (1) FromDate
		...
		RIGHT JOIN EmployeeInOut_10PM_NoWeekend eio
