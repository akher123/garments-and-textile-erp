-- ==============================================================================================================
-- Author:		<Md.Yasir Arafat>/<Golam Rabbi>
-- Create date: <19/03/2015>
-- Description:	<> EXEC SPAppointmentLetter 'cb6ce72b-2c6b-4b16-b370-0b4d6ea76991', 'superadmin','2016-01-28' 
-- =============================================================================================================

CREATE PROCEDURE [dbo].[SPAppointmentLetter]
...
FROM			    	Employee AS  employee
						...
						AND employeeCompanyInfo.rowNum = 1 AND 
						((employee.EmployeeId = @employeeId) OR (@employeeId IS NULL))
