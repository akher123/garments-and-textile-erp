...
-- EXEC [SCERPDB_DEV].[dbo].[HRMSPGetEmployeesForAssigingLine]  -1, -1, -1, -1, -1, -1, -1, '', NULL, NULL, '2015-12-31', 'superadmin' 
-- =========================================================================================================================================

CREATE PROCEDURE [dbo].[HRMSPGetEmployeesForAssigingLine]
...
BEGIN
	...
	BEGIN TRAN
		...
		LEFT JOIN (SELECT EmployeeId, EmployeeCompanyInfoId, PunchCardNo, DesignationId,BranchUnitDepartmentId, DepartmentSectionId, DepartmentLineId,
