...
-- Description:	<> EXEC [SPProcessEmployeeInOut_Original_NoWeekend]  '2017-04-26','2017-05-25', ''
-- ==========================================================================================================================================

CREATE PROCEDURE [dbo].[SPProcessEmployeeInOut_Original_NoWeekend]
...
BEGIN
		...
		BEGIN	
				 ...
				 --   WHERE [ExtraOTHours] > 2 AND OTHours = 2
					...
					--UPDATE EmployeeInOut_Original_NoWeekend	-- Manual OverTime 				 
				 ...
				 --   WHERE [ExtraOTHours] > 2 AND OTHours = 0
				    ...
				    --UPDATE EmployeeInOut_Original_NoWeekend		-- OUT TIME ROUNDING
