...
-- Description:	<> EXEC SPGetEmployeeJobCard_Original_NoWeekend  -1, -1, -1, -1, -1, -1, -1,'4637', 2017, 5, '2017-04-26', '2017-05-25', 'superadmin'			  
-- ==================================================================================================================================================

CREATE PROCEDURE [dbo].[SPGetEmployeeJobCard_Original_NoWeekend]	
...
BEGIN
	   ...
	   (SELECT TOP (1) FromDate
		...
		FROM EmployeeJobCard_Original_NoWeekend ejc
		RIGHT JOIN EmployeeInOut_Original_NoWeekend eio
