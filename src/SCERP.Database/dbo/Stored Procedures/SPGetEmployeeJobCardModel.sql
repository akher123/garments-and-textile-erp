...
-- Description:	<> EXEC SPGetEmployeeJobCardModel   1,  1, 1, -1, -1, -1, -1, '0835', 2018, 02, '2018-01-26', '2018-02-25', 'superadmin'
-- ======================================================================================================================================

CREATE PROCEDURE [dbo].[SPGetEmployeeJobCardModel]	
				@CompanyId INT = -1,
				@BranchId INT = -1,
				@BranchUnitId INT = -1,
...
BEGIN
	   ...
	   (ejc.AbsentDays + CAST(ISNULL( @TotalPenaltyDays, 0) AS INT)) AS AbsentDays,
		...
		RIGHT JOIN EmployeeInOutModel eio
