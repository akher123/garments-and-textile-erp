...
function SearchEmployeeDataButton() {
    ...
    jQuery.ajax({
        url: "/LeaveApplicationOfPaperBased/GetEmployeeData",
        data: {
...
function RecommendedDayCalculation() {

    var fromDate = $('#RecommendedFromDate').val();
    var ToDate = $('#RecommendedToDate').val();
    ...
    if (dateDiff < 1) {
        $('#RecommendedTotalDays').val('');
        alert("Please select valid From Date and To Date");
        return;
    }

    $('#RecommendedTotalDays').val(dateDiff);
}


function ApprovedDayCalculation() {

    var fromDate = $('#ApprovedFromDate').val();
    var ToDate = $('#ApprovedToDate').val();
    ...
    if (dateDiff < 1) {
        $('#ApprovedTotalDays').val('');
        alert("Please select valid From Date and To Date");
        return;
    }

    $('#ApprovedTotalDays').val(dateDiff);
}


function ConsumedDayCalculation() {

    var fromDate = $('#ConsumedFromDate').val();
    var ToDate = $('#ConsumedToDate').val();
    ...
    if (dateDiff < 1) {
        $('#ConsumedTotalDays').val('');
        alert("Please select valid From Date and To Date");
        return;
    }

    $('#ConsumedTotalDays').val(dateDiff);
}
