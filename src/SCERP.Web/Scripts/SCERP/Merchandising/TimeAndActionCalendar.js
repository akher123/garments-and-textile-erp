$('.TimeAndActionCalendar_Buyer').change(function () {
    ...
    TimeAndActionCalendar.PopulateSpecSheetDropdownList(option);
});

$('.TimeAndActionCalendar_StyleNo').change(function () {
    ...
    TimeAndActionCalendar.PopulateJobNumberDropdown(option);
});

$('.TimeAndActionCalendar_department').change(function () {
    var action = $(this).attr('action');
    var targetClassName = $(this).attr('TargetClass');
    var departmentId = $(this).val();
    var option = {
    ...
    TimeAndActionCalendar.PopulateEmployeesDropdownList(option);
});

var TimeAndActionCalendar = {
    ...
    PopulateEmployeesDropdownList: function (option) {
        $.ajax({
            ...
            success: function (resposns) {
                TimeAndActionCalendar.ClearDropDownList(option.targetClass);
