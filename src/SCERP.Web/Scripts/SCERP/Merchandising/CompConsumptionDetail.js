...
$('.PColorColorUpdate').unbind('keypress').bind('keypress', function (e) {
    ...
    if (key == 13) {
        if (consTypeRefId.length > 0) {
            ...
            var option = {
                url: '/CompConsumptionDetail/UpdatePColor',
                data: data,
                type: 'post',
                container: '#ComConsumptionDetailList'
            };
            $.Ajax(option);
...
$('.compConsUpdate').unbind('keypress').bind('keypress', function (e) {
    ...
    if (key == 13) {
        if (consTypeRefId.length > 0) {
            ...
            var data = form.serialize();
            var option = {
                url: '/CompConsumptionDetail/UpdateCompConsDetail',
...
$('.Size_SearchString').unbind('keypress').bind('keypress', function (e) {
    ...
    if (key == 13) {
        if (consTypeRefId.length > 0) {
            ...
            var data = form.serialize();
            var option = {
                url: '/CompConsumptionDetail/UpdateFabricSize',
                data: data,
                type: 'post',
                container: '#ComConsumptionDetailList'
            };
...
$('.SearchSize_TableWidthID').unbind('keypress').bind('keypress', function (e) {
    ...
    if (key == 13) {
        if (consTypeRefId.length > 0) {
            ...
            var data = form.serialize();
            var option = {
                url: '/CompConsumptionDetail/UpdateGrWidh',
                data: data,
                type: 'post',
                container: '#ComConsumptionDetailList'
            };
...
$('.Color_SearchString').unbind('keypress').bind('keypress', function (e) {
    ...
    if (key == 13) {
        if (consTypeRefId.length > 0) {
            ...
            var data = form.serialize();
            var option = {
                url: '/CompConsumptionDetail/UpdateGrColor',
                data: data,
                type: 'post',
                container: '#ComConsumptionDetailList'
            };
...
$('.updateFabricConsQty').unbind('click').bind('click', function (e) {
    ...
    var data = form.serialize();
    var option = {
        url: '/CompConsumptionDetail/UpdateFabricQty',
        data: data,
    };
    $.Ajax(option);
});
