...
function PrintEmbroideryBalanceInPDF(reportType) {
    var form = $('.PrintEmbroideryBalanceForm');
             var data = form.serialize();
             var searchurl = '/Production/ProductionReport/PrintEmbroideryBalance?' + data + '&reportTypeId=' + reportType;
            window.open(searchurl);
}
function PrintEmbroideryBalanceInExcel(reportType) {
    var form = $('.PrintEmbroideryBalanceForm');
    var data = form.serialize();
    var searchurl = '/Production/ProductionReport/PrintEmbroideryBalance?' + data + '&reportTypeId=' + reportType;
    window.open(searchurl);
...
function PrintEmbProcessStatus(reportType) {

    var orderNo = $('#OrderNoDdl').val();
    var orderStyleRefId = $('#OrderStyleRefIdDdl').val();
    var searchurl = '/Production/ProductionReport/PrintEmbProcessStatus?orderNo=' + orderNo + '&orderStyleRefId=' + orderStyleRefId + '&reportType=' + reportType;
    window.open(searchurl);
}
