...
{
    public class StorePurchaseViewModel : VStorePurchaseRequisition
    {
       public bool IsComeFromRequsition { get; set; }
       public VStorePurchaseRequisitionDetail VStorePrDetail { get; set; }
        ...
        public Dictionary<string, VStorePurchaseRequisitionDetail> StorePurchaseRequisitionDetails { get; set; }
        ...
        public StorePurchaseViewModel()
        {
            VStorePrDetail=new VStorePurchaseRequisitionDetail();
            ...
            StorePurchaseRequisitionDetails = new Dictionary<string, VStorePurchaseRequisitionDetail>();
