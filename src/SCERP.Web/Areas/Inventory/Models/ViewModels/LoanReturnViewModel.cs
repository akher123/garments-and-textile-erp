...
{
    public class LoanReturnViewModel : VMaterialLoanReturn
    {
        public List<VMaterialLoanReturn> VMaterialLoanReturns { get; set; }
        ...
        {
            VMaterialLoanReturns = new List<VMaterialLoanReturn>();
