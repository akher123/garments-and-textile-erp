...
{
    public class FabSubProcessReceiveController : BaseController
    {
        ...
        public FabSubProcessReceiveController(IReturnableChallanReceiveMasterManager challanReceiveMasterManager, IReturnableChallanManager returnableChallanManager, IReturnableChallanReceiveManager returnableChallanReceiveManager)
        {
       ...
       [AjaxAuthorize(Roles = "fabsubproessreceived-1,fabsubproessreceived-2,fabsubproessreceived-3")]
        public ActionResult Index(ChallanReceiveMasterViewModel model)
        {
            ...
            {
                var totalRecords = 0;
                model.ChallanReceiveMasterList = _challanReceiveMasterManager.GetChallanReceiveMasterByPaging(model.PageIndex, model.sort, model.sortdir, model.SearchString, PortalContext.CurrentUser.CompId,ChallanType.Fabric, out totalRecords);
      ...
      [AjaxAuthorize(Roles = "fabsubproessreceived-2,fabsubproessreceived-3")] 
       ...
       [AjaxAuthorize(Roles = "fabsubproessreceived-2,fabsubproessreceived-3")] 
        ...
        [AjaxAuthorize(Roles = "fabsubproessreceived-3")] 
        ...
        {
            var returnableChallans = _returnableChallanManager.GetRefNoBySearchCharacter(searchCharacter,ChallanType.Fabric);
