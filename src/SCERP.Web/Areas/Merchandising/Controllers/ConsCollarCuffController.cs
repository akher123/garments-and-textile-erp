...
{
    public class ConsCollarCuffController : BaseController
    {
        ...
        public ConsCollarCuffController(ICompConsumptionDetailManager compConsumptionDetailManager,
        ...
        public ActionResult Index(CompConsumptionDetailViewModel model)
        {
          ...
          model.OrderStyleRefId = consComponet.OrderStyleRefId;
            model.IsCollar = model.CompConsumption.ComponentName.ToLower().StartsWith("collar");
           
          return PartialView("~/Areas/Merchandising/Views/ConsCollarCuff/Index.cshtml", model);
        }

        public ActionResult UpdateCollarCuffConsDetail(CompConsumptionDetailViewModel model)
        {
            try
            {
                var updateInde = _compConsumptionDetailManager.UpdateCollarCuffConsDetail(model, model.UpdateKey);
        ...
        public ActionResult ReloadAction(CompConsumptionDetailViewModel model)
        {
            ...
            return PartialView("~/Areas/Merchandising/Views/ConsCollarCuff/_ConsCollarCuffDetailList.cshtml", model);
        }
