...
{
    public class EmployeeSalaryProcessViewModel : EmployeeProcessedSalary
    {
        public EmployeeSalaryProcessViewModel()
        {
            ...
            EmployeeProcessedSalaryRecords = new List<EmployeeProcessedSalary>();
            EmployeesForSalryProcess = new List<EmployeesForSalaryProcessModel>();
        ...
        public List<EmployeeProcessedSalary> EmployeeProcessedSalaryRecords { get; set; }
        ...
        public IList<EmployeesForSalaryProcessModel> EmployeesForSalryProcess { get; set; }
        public string SubmitButtonDisplayStyle
        {
            get
            {
                return String.Format("style=display:{0}", EmployeesForSalryProcess.Count > 0 ? "" : "none");
            }
        }
