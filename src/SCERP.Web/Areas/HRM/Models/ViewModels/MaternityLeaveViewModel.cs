...
{
    public class MaternityLeaveViewModel : HrmMaternityPayment
    {
        public MaternityLeaveViewModel()
        {
            maternityLeaveInfos = new List<MaternityLeaveInfo>();
        ...
        public List<MaternityLeaveInfo> maternityLeaveInfos { get; set; }
