...
namespace SCERP.Web.Areas.HRM.Models.ViewModels
{
    ...
    public class EmployeeInOutProcessViewModel :EmployeeInOut
    {

        public EmployeeInOutProcessViewModel()
        {
            ...
            EmployeeInOutRecords = new List<EmployeeInOut>();
            EmployeesForInOutProcess = new List<EmployeesForInOutProcessModel>();
        ...
        public List<EmployeeInOut> EmployeeInOutRecords { get; set; }
        ...
        public IList<EmployeesForInOutProcessModel> EmployeesForInOutProcess { get; set; }
        public string SubmitButtonDisplayStyle
        {
            get
            {
                return String.Format("style=display:{0}", EmployeesForInOutProcess.Count > 0 ? "" : "none");
            }
        }
