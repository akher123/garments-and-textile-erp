...
namespace SCERP.Web.Areas.HRM.Models.ViewModels
{
    ...
    public class EmployeeJobCardProcessViewModel :EmployeeJobCard
    {

        public EmployeeJobCardProcessViewModel()
        {
            ...
            EmployeeJobCardRecords = new List<EmployeeJobCard>();
            EmployeesForJobCardProcess = new List<EmployeesForJobCardProcessModel>();
        ...
        public List<EmployeeJobCard> EmployeeJobCardRecords { get; set; }
        ...
        public IList<EmployeesForJobCardProcessModel> EmployeesForJobCardProcess { get; set; }
        public string SubmitButtonDisplayStyle
        {
            get
            {
                return String.Format("style=display:{0}", EmployeesForJobCardProcess.Count > 0 ? "" : "none");
            }
        }
