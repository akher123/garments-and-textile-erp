...
namespace SCERP.Web.Areas.HRM.Models.ViewModels
{
    ...
    public class EmployeeInOutModelProcessViewModel : EmployeeInOutModel
    {

        public EmployeeInOutModelProcessViewModel()
        {
            ...
            EmployeeInOutModelRecords = new List<EmployeeInOutModel>();
            EmployeesForInOutModelProcess = new List<EmployeesForInOutModelProcessModel>();
        ...
        public List<EmployeeInOutModel> EmployeeInOutModelRecords { get; set; }
        ...
        public IList<EmployeesForInOutModelProcessModel> EmployeesForInOutModelProcess { get; set; }
        public string SubmitButtonDisplayStyle
        {
            get
            {
                return String.Format("style=display:{0}", EmployeesForInOutModelProcess.Count > 0 ? "" : "none");
            }
        }
