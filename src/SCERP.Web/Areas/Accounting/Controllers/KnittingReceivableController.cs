...
{
    public class KnittingReceivableController : BaseController
    {
        ...
        public KnittingReceivableController(IJournalVoucherEntryManager journalVoucherEntryManager, IVoucherMasterManager voucherMasterManager, IAccountIntegrationManager accountIntegrationManager)
        {
        ...
        public ActionResult Index(KnittingInvoiceViewModel mode)
        {
            ...
            mode.knittingBills = _accountIntegrationManager.GetKnittingBillInvoice(mode.InvoiceDate,mode.SerarchString??"-1", (int)BillTable.Inventory_GreyIssue);
            return View(mode);
        }

        public ActionResult KnittingReceivableVoucher(VoucherEntryViewModel model)
        {
            ModelState.Clear();
            ...
            Acc_VoucherMaster voucherMaster = _accountIntegrationManager.GetKnittingVoucher(model.Key, (int)BillTable.Inventory_GreyIssue);
