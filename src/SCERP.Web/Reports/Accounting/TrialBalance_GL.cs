...
namespace SCERP.Web.Reports.Accounting {
    ...
    public class TrialBalance_GL : ReportClass {
        
        public TrialBalance_GL() {
        }
        
        public override string ResourceName {
            get {
                return "TrialBalance_GL.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SCERP.Web.Reports.Accounting.TrialBalance_GL.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedTrialBalance_GL : Component, ICachedReport {
        
        public CachedTrialBalance_GL() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            TrialBalance_GL rpt = new TrialBalance_GL();
            rpt.Site = this.Site;
            return rpt;
        }
